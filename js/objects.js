...
person.name.middleName = "Chris";
person.age = 23;
person.gender = "Female";
person.interests.push("playing");
...
/* STEP 4: Add a more complicated function to the object that describes the person, their age, gender, 
    ...
    person.bio = function () {
        return `The interests of ${this.name.firstName} ${this.name.lastName}, aged ${this.age}, gender ${this.gender}, include ${this.interests.join(", ")}.`;
    };
...
output.textContent = `First Name: ${person.name.firstName}, Age: ${person.age}, Gender: ${person.gender}`;

/* STEP 5b: Update the above bio() function inside the person object to return 
the string, instead of the alert(). */
var bioString = person.bio();
